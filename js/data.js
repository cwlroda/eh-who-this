...
const RAW = {
  ...
  indian: {
    given_m: ['Arun', 'Kumar', 'Raj', 'Suresh', 'Muthu', 'Rajagopalan', 'Narayanan', 'Ramesh', 'Ganesh', 'Mahesh', 'Prakash', 'Vijay', 'Anand', 'Bala', 'Deepak', 'Dinesh', 'Gopal', 'Hari', 'Karthik', 'Krishnan', 'Manoj', 'Mohan', 'Nathan', 'Naveen', 'Prem', 'Rahul', 'Ravi', 'Sanjay', 'Saravanan', 'Selvam', 'Senthil', 'Shankar', 'Sivakumar', 'Sundar', 'Thiru', 'Vasanth', 'Velu', 'Vikram', 'Vimal', 'Aravind', 'Ashok', 'Balaji', 'Chandran', 'Eswaran', 'Gopinath', 'Harish', 'Jayaram', 'Karthikeyan', 'Lakshman', 'Madhavan', 'Manickam', 'Murugan', 'Nagaraj', 'Palani', 'Perumal', 'Rajan', 'Rajendran', 'Ramachandran', 'Ramasamy', 'Sathish', 'Shanmugam', 'Sivaraj', 'Subramaniam', 'Thanabalan', 'Vadivelu', 'Veeran', 'Venkatesan', 'Yogendran', 'Adithya', 'Bharath', 'Devan', 'Elango', 'Gokul', 'Indran', 'Jeevan', 'Kannan', 'Logan', 'Mani', 'Nirmal', 'Pandian', 'Rakesh', 'Sasi', 'Tamil', 'Uday', 'Varun', 'Vishnu', 'Yuvan', 'Aditya', 'Bhaskar', 'Chandru', 'Ganesan', 'Hemanth', 'Jagan', 'Kalai', 'Magesh', 'Naren', 'Prabhu', 'Sathyan', 'Theva', 'Vinod'],
    ...
    father: ['Kumar', 'Suppiah', 'Nagaratnam', 'Subramaniam', 'Rajagopal', 'Narayanan', 'Govindasamy', 'Ramasamy', 'Krishnan', 'Perumal', 'Muthusamy', 'Sivasamy', 'Veerasamy', 'Arumugam', 'Balasubramaniam', 'Chandrasekaran', 'Dhanabalan', 'Ganesan', 'Gopalakrishnan', 'Harikrishnan', 'Jayaraman', 'Kandasamy', 'Lakshmanan', 'Nadarajah', 'Palanisamy', 'Pillai', 'Rajaratnam', 'Ramalingam', 'Sankaran', 'Sathasivam', 'Selvaraj', 'Shanmugam', 'Sivanandam', 'Sockalingam', 'Tamilselvan', 'Thangavelu', 'Thirumalai', 'Vairavan', 'Velayudham', 'Venkataraman', 'Vythilingam', 'Annamalai', 'Ayyappan', 'Bhaskaran', 'Chidambaram', 'Elangovan', 'Govindaraju', 'Jeyaratnam', 'Kaliappan', 'Karuppiah', 'Maniam', 'Marimuthu', 'Murugaiah', 'Nallathamby', 'Ponnusamy', 'Rajamani', 'Ramachandran', 'Sabapathy', 'Sellappan', 'Singaram', 'Sundaram', 'Thiruvengadam', 'Vadivelu', 'Visvanathan', 'Anbalagan', 'Boopathy', 'Chinnasamy', 'Devadas', 'Gunasekaran', 'Kuppusamy', 'Letchumanan', 'Mahalingam', 'Natarajan', 'Periasamy', 'Ragunathan', 'Sivakumar', 'Thandapani', 'Varadan', 'Yogarajah', 'Alagappan', 'Chellappa', 'Doraisamy', 'Munusamy', 'Renganathan', 'Somasundaram', 'Vetrivel', 'Arokiasamy', 'Devarajan', 'Kandiah', 'Manoharan', 'Pakirisamy', 'Rasiah', 'Sinniah', 'Thambusamy', 'Veerappan', 'Aiyappan', 'Chockalingam', 'Madasamy', 'Ratnasingam'],
  },

  eurasian: {
    // Christian given names; these double as middle names (roles: first + middle)
    first_m: ['Michael', 'John', 'Anthony', 'Joseph', 'Francis', 'Gerald', 'Bernard', 'Clifford', 'Desmond', 'Lawrence', 'Patrick', 'Vincent', 'Wilfred', 'Aloysius', 'Andrew', 'Augustine', 'Benedict', 'Bertram', 'Christopher', 'Cuthbert', 'Cyril', 'Damien', 'Dominic', 'Edgar', 'Edmund', 'Edward', 'Felix', 'Ferdinand', 'Frederick', 'Gabriel', 'George', 'Gilbert', 'Gregory', 'Harold', 'Hubert', 'Ignatius', 'Isaac', 'Jerome', 'Julian', 'Leonard', 'Leopold', 'Lucas', 'Luke', 'Marcus', 'Mark', 'Martin', 'Matthias', 'Maurice', 'Maximilian', 'Nicholas', 'Noel', 'Oswald', 'Percival', 'Peter', 'Philip', 'Quentin', 'Raphael', 'Raymond', 'Reginald', 'Rudolph', 'Sebastian', 'Stephen', 'Sylvester', 'Theodore', 'Thomas', 'Valentine', 'Victor', 'Walter', 'Xavier', 'Adrian', 'Albert', 'Alexander', 'Allan', 'Bartholomew', 'Casimir', 'Clarence', 'Clement', 'Conrad', 'Cornelius', 'Crispin', 'Eugene', 'Fabian', 'Gerard', 'Hilary', 'Horace', 'Humphrey', 'Ivan', 'Lionel', 'Malcolm', 'Norbert', 'Oscar', 'Roderick', 'Roland', 'Rowland', 'Terence', 'Urban', 'Wilbert', 'Aldrin', 'Brendan', 'Lucius'],
    ...
    surname: ['Pereira', 'de Souza', 'Theseira', 'de Silva', 'Oliveiro', 'Aeria', 'Klyne', 'Minjoot', 'Almeida', 'Carvalho', 'de Costa', 'de Cruz', 'Gomes', 'Lazaroo', 'Lopez', 'Machado', 'de Mello', 'Monteiro', 'Nonis', 'Nunis', 'Pestana', 'Pinto', 'Rodrigues', 'Santa Maria', 'Sequerah', 'Skelchy', 'Vaas', 'Xavier', 'Cardoza', 'Fernandez', 'Fernando', 'Dias', 'Ferrao', 'Sequeira', 'de Rozario', 'Clarke', 'Woodford', 'Leicester', 'Shepherdson', 'Eber', 'Scharenguivel', 'Tessensohn', 'Westerhout', 'Hendricks', 'Holloway', 'Pennefather', 'Restall', 'Rozells', 'Anthonisz', 'Baptist', 'Bostock', 'Conceicao', 'Danker', 'Desker', 'Doray', 'Frois', 'Gracie', 'Hertogh', 'Jansen', 'Joaquim', 'Koek', 'La Brooy', 'Lazarus', 'Maddever', 'Marbeck', 'Martens', 'Neubronner', 'Oehlers', 'Ollero', 'Paglar', 'Perera', 'Phillips', 'Picardo', 'Pohl', 'Reutens', 'Rodyk', 'Scully', 'Siebel', 'Spykerman', 'Tavares', 'Toomey', 'Vanderstraaten', 'Verghese', 'Verloop', 'de Conceicao', 'de Wit', 'Edwards', 'Hyde', 'Lourdes', 'Maximus', 'Netto', 'Olivero', 'Quadra', 'Remedios', 'Salgado', 'Texeira', 'Vandenberg', 'Wilkinson', 'Young', 'Zuzarte'],
  },
};
